...
public class DilemmaAdminAsObjectsDAO {
    ...
    private List<DilemmaSubjects> dilemmaSubjectList = new ArrayList<DilemmaSubjects>();
    ...
    public DilemmaAdminAsObjects getDilemmaAdminAsObject() {
        ...
        dilemmaAdminAsObjects.setDilemmaSubjectsList(dilemmaSubjectDAO.getAllSubjects());
